...
import org.nuata.authentication.oauth.facebook.{FacebookToken, FacebookUserInfo}
import org.nuata.authentication.oauth.github.{GithubCode, GithubUserInfo}
 ...
 */
object OauthService extends RouteProvider with Json4sProtocol {
